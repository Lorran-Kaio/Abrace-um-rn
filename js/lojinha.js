const produtos = [
  ...
  },
  {
    ...
    categoria: 'acessorios',
    descricao:
      'Estojo especial para seus produtos de autocuidado. Ideal para fazer kits de higiene, maquiagem, manicure e muito mais!',
  },
  {
    id: 5,
    ...
    categoria: 'acessorios',
    descricao:
      'Copo térmico personalizado com nome, ideal para manter sua bebida na temperatura certa!',
  },
  {
    id: 6,
    ...
    categoria: 'acessorios',
    descricao:
      'Canetas personalizadas com o tema de sua preferência, perfeitas para lembrancinhas ou uso diário.',
  },
  {
    id: 7,
    ...
    categoria: 'acessorios',
    descricao:
      'Necessaire em formato de maletinha com transparência frontal e personalizada. Ideal para organizar seus itens de forma prática e estilosa. É só escolher o tema e nós fazemos para você!',
  },
  {
    id: 8,
    ...
    categoria: 'roupas',
    descricao:
      'Camisa sublimada personalizada com o tema de sua escolha. Confortável e estilosa, perfeita para qualquer ocasião.',
  },
  {
    id: 10,
    ...
    categoria: 'papelaria',
    descricao:
      'Marca páginas personalizados com o tema de sua escolha. Ótimos para presentear ou usar no dia a dia.',
  },
  {
    id: 11,
    nome: 'Necessaire transparente',
    ...
    categoria: 'acessorios',
    descricao:
      'Necessaire linda e prática para organizar seus itens pessoais. Com design elegante e funcional, ideal para uso diário ou viagens.',
  },
  {
    id: 12,
    ...
    categoria: 'acessorios',
    descricao:
      'Canecas personalizadas com o tema de sua escolha. Perfeitas para presentear ou para uso pessoal, trazendo um toque especial ao seu café ou chá.',
  },
  {
    id: 16,
    ...
    descricao:
      'Organizador de gavetas para roupas de bebê ou peças íntimas com 3 variações de formato e tamanho, personalizado para a sua necessidade. Ajuda a manter tudo no lugar e facilita na hora de escolher as roupinhas do dia.',
  },
  {
    id: 22,
    ...
    categoria: 'acessorios',
    descricao:
      'Kit com 2 necessaires impermeáveis, espaçosas e perfeitas para organizar itens de higiene, maquiagem ou acessórios. Práticas e fáceis de limpar, ideais para viagens ou uso diário.',
  },
]
        ...
        <div class="modal-body">
          ...
          <div class="modal-info">
            ...
            <div class="modal-actions">
              ...
              <button class="btn-whatsapp" onclick="entrarEmContatoWhatsApp(${
                produto.id
              })">
